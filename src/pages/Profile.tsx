                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div className="bg-background/50 p-4 rounded-lg border border-border/30">
                      ...
                      <p className="text-2xl font-bold">{profile.average_wpm || 0}</p>
                    </div>
                    <div className="bg-background/50 p-4 rounded-lg border border-border/30">
                      <h3 className="text-sm font-medium text-muted-foreground">Best WPM</h3>
                      <p className="text-2xl font-bold">{profile.best_wpm || 0}</p>
                    </div>
                    <div className="bg-background/50 p-4 rounded-lg border border-border/30">
                      <h3 className="text-sm font-medium text-muted-foreground">Tests Completed</h3>
                      <p className="text-2xl font-bold">{profile.total_tests || 0}</p>
                    </div>
                    <div className="bg-background/50 p-4 rounded-lg border border-border/30">
                      <h3 className="text-sm font-medium text-muted-foreground">User ID</h3>
                      <p className="text-xs font-mono truncate" title={profile.id}>
                        {profile.id ? profile.id.substring(0, 8) + '...' : 'N/A'}
                      </p>
                    </div>
                  </div>
